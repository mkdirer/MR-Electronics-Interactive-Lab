...
public class FirstTaskMenuController : MonoBehaviour
{
    ...
    {
        "Safe start", //instrukcja detekcji nagraæ detekcjê przyk³dow¹ do komponentów, fragment z aplikacji
        ...
        "Measure the Step Response", //nagraæ filmik (pomiary skoku) z oscyloskopu
