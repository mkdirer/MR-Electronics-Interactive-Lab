...
*/
public class FourthTaskMenuController : MonoBehaviour
{
    ...
    {
    "Secure Start", //instrukcja detekcji nagraæ detekcjê przyk³dow¹ do komponentów, fragment z aplikacji
    ...
    "Calculate the Cutoff Frequency", //nagrac filmik ?
    ...
    "Capture the Step Response", //nagraæ filmik (pomiary skoku) z oscyloskopu
    ...
    private void UpdateLevelContent()
    {
        ...
        levelTextContent.text = levelTaskContent4[currentLevel-1];
        levelText.text = levelTaskTitle4[currentLevel - 1];
